...
import { Meta, useParams, Link } from "react-router";
      ...
      <div className="order-invoice my-5">
        ...
        <div id="order_invoice" className="p-3 border border-secondary">
          <header className="clearfix">
            <div id="logo">
              <img src="../public/images/invoice-logo.png" alt="Company Logo" />
            </div>
            ...
            <table className="mt-5">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="total">${order?.shippingAmount.toFixed(2)}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="grand total">${order?.totalAmount.toFixed(2)}</td>
                </tr>
              </tbody>
            </table>
            <div id="notices">
